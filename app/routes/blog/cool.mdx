...
Ao compararmos as novas variáveis usando <code>console.log()</code>, ele vai nos retornar <code>true</code>, pois o javascript compara os primitivos de acordo com os seu conteúdo.

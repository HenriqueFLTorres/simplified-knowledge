...
const BlogCard = ({
  ...
  return (
    <Link to={`blog/${postURL}`}>
      <div className="flex flex-col relative group h-[300px] w-[350px] cursor-pointer bg-gradient-to-b from-neutral-200 to-neutral-200/40 dark:from-neutral-800 dark:to-neutral-800/40 rounded-tl-3xl rounded-br-3xl clip-path-inset">

...
const BlogCard = ({ name, link, image, date, readTime, tags }: Props) => {
  ...
  const aaaa = formatRelative(uploadDate, new Date(), { locale: ptBR });
  ...
  return (
    <Link to={`blog/${link}`}>
      <div className="group h-[300px] w-[350px] cursor-pointer bg-neutral-200 dark:bg-neutral-800 rounded-tl-3xl rounded-br-3xl hover:scale-110 transition-transform duration-[400ms]">
        <div className="w-full h-[150px] rounded-tl-3xl bg-gradient-to-tl from-[#f89720] to-[#fed006] group-hover:h-[190px] transition-all clip-path-inset duration-[400ms]">
          <img src={image} alt="" className="rounded-tl-3xl object-contain" />
        ...
        <div className="px-5 py-2.5 h-[150px] flex flex-col justify-between group-hover:h-[110px] transition-all duration-[400ms]">
          ...
          <footer className="flex flex-row justify-between">
            <p className="text-lg text-neutral-400 font-semibold">{aaaa}</p>
